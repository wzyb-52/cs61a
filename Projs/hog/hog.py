...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score[0] < goal and score[1] < goal:
        ...
        num_roll = strategy[who](score[who], score[oppo])
        new_score = take_turn(num_roll, score[oppo], dice)
        # Considering the Feral Hogs.
        hog_flag, prev[who] = abs(num_roll - prev[who]) == 2, new_score
        score[who] += new_score 
        if hog_flag and feral_hogs:
            score[who] += 3
        # Considering the Swine Swap
        swap_flag = is_swap(score[who], score[oppo])
        if swap_flag:
