...
def eval_all(expressions, env):
    ...
    """
    # BEGIN PROBLEM 7
    expression, last_value = expressions, None
    while expression is not nil:
        expression, last_value = expression.rest, scheme_eval(expression.first, env)
    return last_value
    # END PROBLEM 7
...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        if len(formals) != len(vals):
            raise SchemeError("wrong numbers of formal parameters and values")
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 9
        target, formals, body = target.first, target.rest, expressions.rest
...
def do_and_form(expressions, env):
    ...
    """
    # BEGIN PROBLEM 12
    expression, last_value = expressions, True
    while expression is not nil and is_true_primitive(last_value):
        last_value, expression = scheme_eval(expression.first, env), expression.rest
    return last_value
    # END PROBLEM 12
...
def do_or_form(expressions, env):
    ...
    """
    # BEGIN PROBLEM 12
    expression, last_value = expressions, False
    while expression is not nil and not is_true_primitive(last_value):
        last_value, expression = scheme_eval(expression.first, env), expression.rest
    return last_value
    # END PROBLEM 12
...
def make_let_frame(bindings, env):
    ...
    while expressions is not nil:
        binding, expressions = expressions.first, expressions.rest
